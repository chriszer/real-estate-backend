...
-- DropForeignKey
ALTER TABLE "applications" DROP CONSTRAINT "applications_leaseId_fkey";

-- DropForeignKey
ALTER TABLE "applications" DROP CONSTRAINT "applications_propertyId_fkey";

-- DropForeignKey
ALTER TABLE "applications" DROP CONSTRAINT "applications_tenantCognitoId_fkey";

-- DropForeignKey
ALTER TABLE "leases" DROP CONSTRAINT "leases_propertyId_fkey";

-- DropForeignKey
ALTER TABLE "leases" DROP CONSTRAINT "leases_tenantCognitoId_fkey";
...
-- DropForeignKey
ALTER TABLE "properties" DROP CONSTRAINT "properties_managerCognitoId_fkey";
